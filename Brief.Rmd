...
ggsave("Figs/RPB-All Cond.jpg", dpi = 1000, width = 11, height = 8.5)
...
ggsave("Figs/RPB-Cond by Param.jpg", dpi = 1000, width = 11, height = 8.5)
```
...
ggsave("Figs/RPB-X_M Cor by Parameter.jpg", dpi = 1000, width = 11, height = 8.5)
...
#          linetype = guide_legend(title = "Estimating Weights"))
# 
# ggsave("Figs/RPB-X_M Cor by Parameter-Mj only.jpg", dpi = 1000, width = 11, height = 8.5)
...
df_sum2 %>%
  ...
  facet_wrap(Parameter ~ M.m, ncol = 2) +
  scale_fill_brewer(type = "seq", palette = 1, guide=FALSE) +
  scale_color_brewer(type = "qual", palette = 2) +
  theme_minimal() +
  labs(x = "Generating Weights", y = "RPB") +
...
ggsave("Figs/RPB-Prec M by Parameter.jpg", dpi = 1000, width = 11, height = 8.5)
...
df_sum2 %>%
  ...
  facet_wrap(Parameter ~ ICC, ncol = 2) +
  scale_fill_brewer(type = "seq", palette = 1, guide=FALSE) +
  scale_color_brewer(type = "qual", palette = 2) +
  theme_minimal() +
  labs(x = "Generating Weights", y = "RPB") +
...
ggsave("Figs/RPB-ICC by Parameter.jpg", dpi = 1000, width = 11, height = 8.5)
...
df_sum2 %>%
  ...
  facet_wrap(Parameter ~ Bs, ncol = 2) +
  scale_fill_brewer(type = "seq", palette = 1, guide=FALSE) +
  scale_color_brewer(type = "qual", palette = 2) +
  theme_minimal() +
  labs(x = "Generating Weights", y = "RPB") +
...
ggsave("Figs/RPB-L2 effects by Parameter.jpg", dpi = 1000, width = 11, height = 8.5)
```
...
ggsave("Figs/FE_Mj RPB-Perc M by Cor.jpg", dpi = 1000, width = 11, height = 8.5)
```
...
ggsave("Figs/FE_Mj RPB-Perc M by L2 and Cor.jpg", dpi = 1000, width = 11, height = 8.5)
